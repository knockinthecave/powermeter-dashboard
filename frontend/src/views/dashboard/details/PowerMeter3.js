...
const PowerMeter3 = () => {
  ...
  const normalizedVoltageR = (powerMeter3Data.voltageR / maxVoltageS) * 100

  const maxActivePower = 5000
  const normalizedActivePower = (powerMeter3Data.activePower / maxActivePower) * 100
            ...
            <CRow>
              ...
              <CCol xs={6} md={4} xl={4} className="text-align">
                <div className="mb-4">
                  ...
                  <span style={{ fontSize: '3rem' }}>{powerMeter3Data.voltageR} V</span>
                </div>
                <div className="mb-4">
                  <div className="text-body-secondary">전류 R상</div>
                  <span style={{ fontSize: '3rem' }}>{powerMeter3Data.currentR} A</span>
                </div>
              </CCol>
              ...
              <CCol xs={6} md={4} xl={4} className="text-align">
                <div className="mb-4">
                  ...
                  <span style={{ fontSize: '3rem' }}>{powerMeter3Data.voltageS} V</span>
                </div>
                <div className="mb-4">
                  <div className="text-body-secondary">전류 S상</div>
                  <span style={{ fontSize: '3rem' }}>{powerMeter3Data.currentS} A</span>
                </div>
              </CCol>
              ...
              <CCol xs={6} md={4} xl={4} className="text-align">
                <div className="mb-4">
                  ...
                  <span style={{ fontSize: '3rem' }}>{powerMeter3Data.voltageT} V</span>
                </div>
                <div className="mb-4">
                  <div className="text-body-secondary">전류 T상</div>
                  <span style={{ fontSize: '3rem' }}>{powerMeter3Data.currentT} A</span>
                </div>
              </CCol>
            </CRow>
            ...
            <CRow>
              ...
              <CCol xs={6} md={4} xl={4} className="text-align">
                <div className="mb-4">
                  ...
                  <span style={{ fontSize: '3rem' }}>{powerMeter3Data.activePower} W</span>
                </div>
                <div className="mb-4">
                  <div className="text-body-secondary">무효전력</div>
                  <span style={{ fontSize: '3rem' }}>{powerMeter3Data.reactivePower} var</span>
                </div>
              </CCol>
              ...
              <CCol xs={6} md={4} xl={4} className="text-align">
                <div className="mb-4">
                  ...
                  <span style={{ fontSize: '3rem' }}>{powerMeter3Data.effectiveEnergy} Wh</span>
                </div>
                <div className="mb-4">
                  <div className="text-body-secondary">무효전력량</div>
                  <span style={{ fontSize: '3rem' }}>{powerMeter3Data.reactiveEnergy} varh</span>
                </div>
              </CCol>
            </CRow>
          </CCardBody>
